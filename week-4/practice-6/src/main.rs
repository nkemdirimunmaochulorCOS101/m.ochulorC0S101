fn main(){
   ...
   let w3 = w1 + &w2;  
   println!();
   println!("{} is aimed at developing competent, creative, innovative, entrepreneurial and ethically-minded persons, capable of creaating value in the diverse fields of Computer Science. ",w3);
